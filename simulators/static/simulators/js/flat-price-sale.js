...
function make_tweet_share(text) {
    return $('.twitter_share').html('<a href="https://twitter.com/share?url=https://tousimu.work/flat-price-sale&text=' + text + '" rel="nofollow" target="_blank" class="btn twitter rounded-pill btn-sm"><i class="fa fa-twitter"></i> Tweet</a>');
}
